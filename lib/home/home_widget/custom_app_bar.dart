...
final List<Map<String, dynamic>> products = [
  {
    ...
    'manufacturer': {'id': 100, 'name': 'Apple', 'country': 'USA'},
  },
  {
    'id': 2,
    'name': 'Galaxy S24',
    'price': 899,
    'category': {'id': 10, 'name': 'Smartphones'},
    'manufacturer': {'id': 101, 'name': 'Samsung', 'country': 'South Korea'},
  },
  {
    'id': 3,
    'name': 'MacBook Pro',
...
String c(List<Map<String, dynamic>> products) {
  ...
  for (final product in products) {
    final country =
        (product['manufacturer'] as Map<String, dynamic>)['country'] as String;
    if (country == 'USA') {
