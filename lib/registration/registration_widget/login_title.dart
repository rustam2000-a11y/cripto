...
class LoginTitle extends StatelessWidget {
  const LoginTitle({super.key, required this.firstText, required this.secondaryText});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        CustomNewText(text: secondaryText,fontSize: 15,color:  AppColors.textSecondary,),
      ],
    );
  }
}
